    ...
    <form action="#" method="post">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" id="email" name="email" placeholder="Informe o seu email" class="form-control <?= $errors['email'] ? 'is-invalid' : '' ?>" value="<?= $email ?>">
                <div class=" invalid-feedback">
                    <?= $errors['email'] ?>
                </div>
            </div>
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="password" id="password" name="password" placeholder="Informe a sua password" class="form-control <?= $errors['password'] ? 'is-invalid' : '' ?>">
                <div class="invalid-feedback">
                    <?= $errors['password'] ?>
                </div>
            </div>
            <div class="form-group col-md-6">
                ...
                <input type="password" id="confirm_password" name="confirm_password" placeholder="Confirmar a sua password" class="form-control <?= $errors['confirm_password'] ? 'is-invalid' : '' ?>">
                <div class="invalid-feedback">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                <label for="start_date">Data de admissão do funcionário</label>
            ...
            <div class="form-group col-md-6">
                <label for="end_date">Data da saída do funcionário</label>
